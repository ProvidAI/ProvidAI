"""HCS-10 coordination tools for Negotiator."""
...
async def submit_negotiation_message(
    task_id: str, message_type: str, payload: Dict[str, Any]
) -> Dict[str, Any]:
    """
    Submit a negotiation message to HCS-10 topic.

    Args:
        task_id: Task ID
        message_type: Message type (e.g., "payment_initiated", "payment_authorized")
        payload: Message payload with negotiation details
